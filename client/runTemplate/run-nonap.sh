...
for ((QPS=300;QPS>=10;QPS=QPS-15)); do
    ...
    pyPid=$!
    sudo time taskset -c 32 ../../microbench/matrix_nonap > c_log_${QPS}_${ITERs}.txt  2>&1 &
    matrix_pid=$!
    ...
    mkdir -p ${QPS}_${ITERs}_nonap_co
    mv c_log_${QPS}_${ITERs}.txt  ${QPS}_${ITERs}_nonap_co/
    mv py_log_${QPS}_${ITERs}.txt ${QPS}_${ITERs}_nonap_co/
    mv test_${QPS}_${ITERs} ${QPS}_${ITERs}_nonap_co/

    # Parse Task
    cd ${QPS}_${ITERs}_nonap_co
